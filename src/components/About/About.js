    ...
    <>
      <AboutDiv id="about">
        <AboutWrapper>
          <LeftDiv>
            <h3>
              Mobile <br /> Hairdresser in Leeds
            </h3>
            <span>
              Welcome to Destiny. We provide high quality hair & beauty services
              at an affordable price throughout Central London. Haircuts, hair
              extensions, bridal hair & beauty, colour, blow dry, highlights,
              keratin, balayage, threading and more…
            </span>
            <ButtonDiv
              to="prices"
              smooth={true}
